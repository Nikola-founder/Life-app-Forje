    ...
    <div className="min-h-screen flex items-center justify-center bg-parchment px-4">
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit} className="card p-6 flex flex-col gap-4">
          <div>
            <label htmlFor="login-email" className="text-sm font-body text-inkSoft mb-1 block">Email</label>
            <input
              id="login-email"
              type="email"
              autoComplete="email"
          ...
          <div>
            <label htmlFor="login-password" className="text-sm font-body text-inkSoft mb-1 block">Password</label>
            <input
              id="login-password"
              type="password"
