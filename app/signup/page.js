      ...
      <div className="w-full max-w-sm">
        ...
        {done ? (
          ...
          <form onSubmit={handleSubmit} className="card p-6 flex flex-col gap-4">
            <div>
              <label htmlFor="signup-email" className="text-sm font-body text-inkSoft mb-1 block">Email</label>
              <input
                id="signup-email"
                type="email"
                autoComplete="email"
            ...
            <div>
              <label htmlFor="signup-password" className="text-sm font-body text-inkSoft mb-1 block">Password</label>
              <input
                id="signup-password"
                type="password"
            ...
            {error && <p role="alert" className="text-brick text-sm font-body">{error}</p>}
